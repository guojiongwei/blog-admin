<template>
    <section class="blog-wrapper">
        <ul v-if="blogList.length > 0">
            <li class="article" v-for="(v, index) in blogList" :style="{'animation-delay': index%5*0.2+'s'}" @click="$router.push(`/article/${v._id}`)" :index='index'>
                ...
                <div class="tags">
                    <Tag v-for="{tag, index} in v.type" :key :text="tag" :key="index" :path="tag"></Tag>
                </div>
